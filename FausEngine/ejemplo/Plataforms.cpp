...
void Plataforms::Init() {
	...
	material1.Load({ 0.1f,0.1f,0.1f }, { 0.1f,0.1f,0.1f }, { 1,1,1 }, 2.5f, "Textures/plataforma1.png");
	...
	material2.Load({ 0.1f,0.1f,0.1f }, { 0.1f,0.1f,0.1f }, { 1,1,1 }, 5, "Textures/plataforma2.png");
	...
	material3.Load({ 0.1f,0.1f,0.1f }, { 0.1f,0.1f,0.1f }, { 0.5f,0.5f,0.5f }, 5, "Textures/plataforma3.png");
	...
	material4.Load({ 0.1f,0.1f,0.1f }, { 0.1f,0.1f,0.1f }, { 0.5f,0.5f,0.5f }, 5, "Textures/plataforma4.png");
